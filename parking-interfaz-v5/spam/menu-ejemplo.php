  ...
  <div class="pages-stack">
    ...
    <div class="page" id="page-home">
      ...
      <header class="bp-header cf">
        <span class="bp-header__present">Buscar clientes<span class="" data-content="The Blueprints are a collection of basic and minimal website concepts, components, plugins and layouts with minimal style for easy adaption and usage, or simply for inspiration."></span></span>
        <h1 class="bp-header__title"></h1>
        <p class="bp-header__desc"><a href="consultar.php">Clientes</a></p>
        <nav class="bp-nav">
      ...
      <img class="poster" src="images/home-1.png" alt="img01" />
