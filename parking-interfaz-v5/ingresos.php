		...
		<table class="table table-borderer">
			<form action="buscar_ingresos.php" method="POST">
				<div class="form-group" align="center">
					<b>BUSQUEDA DE SERVICIO: </b><input type="text" id="campo" name="placa" placeholder="INGRESE PLACA" style="text-transform:uppercase;" autofocus required  maxlength="6" minlenght="6">
					<input type="submit" class="btn btn-info" id="buscar" name="buscar_ingresos" value="BUSCAR"><br>
				</div>
			</form>
