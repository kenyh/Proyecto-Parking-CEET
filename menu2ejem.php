...
<!--<nav class="bp-nav">
<a class="bp-nav__item bp-icon bp-icon--prev" href="index.php" data-info="previous Blueprintsueprint"><span>Previous Blueprint</span></a>
...
<img class="poster" src="images/logopar.png " alt="img01" />
</div>
<!-- /page -->

<div class="page" id="page-docu">
<header class="bp-header cf">
<h1 class="bp-header__title">Busqueda</h1>
<p class="bp-header__desc">Para busqueda del usuario <a href="https://dribbble.com/shots/2286042-Stacked-navigation">Clik aqui</a></p>
<p class="info">
</p>
<p 
